...
public class User {
    ...
    // ✅ FIXED CONSTRUCTOR (safe mutable collections)
    public User(String email, String password, String firstName, String lastName, String phoneNumber,
                String addressLine1, String addressLine2, String city, String state, String postalCode,
                String verificationCode, Date createdTime, String photos, boolean enabled, Set<Role> roles,
                String resetPasswordToken, List<Ordo> ordonnances) {
        ...
        // prevent Hibernate crash: convert to mutable sets/lists
        this.roles = (roles != null) ? new HashSet<>(roles) : new HashSet<>();
        this.resetPasswordToken = resetPasswordToken;
        this.ordonnances = (ordonnances != null) ? new ArrayList<>(ordonnances) : new ArrayList<>();
    }
    ...
    public List<Ordo> getOrdonnances() { return ordonnances; }
    public void setOrdonnances(List<Ordo> ordonnances) { this.ordonnances = ordonnances; }
